...
sequential, OpenMP, and two GPU placements, plus the parallel STL. The
GPU examples are opt-in through `TDLS_BUILD_CUDA_EXAMPLES`,
`TDLS_BUILD_HIP_EXAMPLES` or `TDLS_BUILD_STDPAR_DEVICE_EXAMPLES`;
