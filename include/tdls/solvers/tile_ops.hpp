#ifndef TDLS_SOLVERS_TILE_OPS_HPP
#define TDLS_SOLVERS_TILE_OPS_HPP
...
///
/// A tile is a TSxTS register array with row stride TS; partial
/// (trailing) tiles use the same storage with extent template parameters
/// bounding every loop, so phantom slots are never read or written and
/// cost nothing.
///
...
/// \brief TSxTS register-tile micro-kernels shared by the solver
/// families.
/// \tparam T            scalar type
...
#endif // TDLS_SOLVERS_TILE_OPS_HPP
